...
const Featured = () => {
  const { loading } = useFetch(
     ...
     "https://hotel-booking-backend-vi05.onrender.comapi/hotels/countByCity?cities=chennai,newdelhi,mumbai"
    // "http://localhost:3000/api/hotels/countByCity?cities=chennai,newdelhi,mumbai"
  );
